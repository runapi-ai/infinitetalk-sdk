package ai.runapi.infinitetalk.resources;
...
public final class AudioToVideoResource extends InfinitetalkResource {
  /** API endpoint path for audio to video operations. */
  public static final String ENDPOINT = "/api/v1/infinitetalk/audio_to_video";
